	...
	<body>
	    ...
	    <div class="container-fluid">
	        <div class="row">
	            ...
	            <div class="col-md-10" >
	                <iframe id="mainPage" src="/repair_system/BackgroundAdmin/Index/welcome.html" frameBorder="0" width="100%" scrolling="yes" height="800"></iframe>
	            </div>
	        </div>
	    </div>
	    <div class="footer">
	    	<div class="title">
	    		code by SteveWoo. version:1.1.1 name:跟上我的节拍    system maintenance：GoodJob
	    		<br>
	    		birthday:2017-3-7
	    	</div>
	    </div>
